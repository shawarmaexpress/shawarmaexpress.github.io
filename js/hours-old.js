var times = [ 
    { open: 11, close: 1 }, //Sunday
    { open: 10.5, close: 22 }, //Monday
    { open: 10.5, close: 22 }, //Tuesday
    { open: 10.5, close: 25 }, //Wednesday
    { open: 10.5, close: 1 }, //Thursday
    { open: 10.5, close: 3.75 }, //Friday
    { open: 11, close: 3.75 }, //Saturday { open1: 11.5, close1: 14, open2: 17, close2: 22 }
];
var date = new Date();
date.setDate(23);
...
var message = 'Our hours today are '; // message if open
...
if (openClosed) {
    if (hasSimpleOpeningHours(openingTimes)){
        message += formatHours(openingTimes.open) + ' to ' + formatHours(openingTimes.close);
    } //  else if (hasComplexOpeningHours(openingTimes)) {
    //     if (openingTimes.open1 <= hour && hour < openingTimes.close1) {
    //         message = 'Lunch hours today are ' + formatHours(openingTimes.open1) + ' to ' + formatHours(openingTimes.close1);
    //     } else if (openingTimes.open2 <= hour && hour < openingTimes.close2) {
    //         message = 'Dinner hours today are ' + formatHours(openingTimes.open2) + ' to ' + formatHours(openingTimes.close2);
    //     }
    // }
}
